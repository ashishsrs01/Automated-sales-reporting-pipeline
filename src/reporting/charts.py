...
def plot_salesperson_revenue(
    report: ReportData,
    output_dir: Path,
) -> Path:
    """Create salesperson revenue chart."""

    dataframe = (
        report.tables.by_salesperson
        .sort_values(
            "Revenue",
            ascending=False,
        )
...
def generate_all_charts(
    ...
    return {
        ...
        "revenue_by_category": plot_revenue_by_category(
            report,
            output_dir,
        ),
        ...
        "salesperson_revenue": plot_salesperson_revenue(
            report,
            output_dir,
        ),
    }